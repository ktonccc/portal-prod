...
> - BancoEstado tiene credenciales sandbox cargadas (commerce `frata`, API key y JWT). Las URLs de sandbox/producción están pendientes de habilitación por BancoEstado; no hay pruebas end-to-end aún.  
