...
return [
    ...
    'webpay' => [
        ...
        // Configuración por empresa (IdEmpresa). Si no aplica, se usa el bloque base de padre las casas.
        'companies' => [
            // Frata BP
            '764430824' => [
                'label' => 'Frata BP',
            ...
            '765316081' => [
                'label' => 'WAM BP',
                'commerce_code' => '597053062413',
                'api_key' => '38adfcde-4231-4380-b57e-d503d6166003',
                'environment' => 'PRODUCCION',
                'return_url' => 'https://pagos.homenet.cl/return.php',
                'final_url' => 'https://pagos.homenet.cl/final.php',
            ],
    ...
    'bancoestado' => [
        ...
        'api_key' => getenv('BANCOESTADO_API_KEY') ?: 'fE0XwO7zXE6PtwPnQh3CU7ogyqRJCqyf4uvTZhlN',
        'commerce' => getenv('BANCOESTADO_COMMERCE') ?: 'frata',
        ...
        'jwt_secret' => getenv('BANCOESTADO_JWT_SECRET') ?: 'd0cace66-df76-4b59-8e9d-868a11ff7871',
